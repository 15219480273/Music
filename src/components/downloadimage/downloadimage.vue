            ...
            <div class="imagecontent">
                ...
                <div class="detail">
                    ...
                    <div class="tips">
                        ...
                        <span v-if="sheetData.tips" class="span-tips" v-for="item in sheetData.tips" :key="item.id">{{item}}</span>
                    </div>
                </div>
            </div> 
            <div class="bottom">
...
//接收传递的数据
  ...
  watch:{
      //???????????
      showImage:function(newisshwo,oldisshwo){
  ...
  methods:{
      cancelDownload(){
          //跟其父组件（songsheet）使用时传递的@hidedownloadimage="hideDownloadImg"相关联
